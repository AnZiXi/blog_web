<template>
    <div class="TagMange">
        ...
        <el-dialog title="创建标签" :visible.sync="createdialogFormVisible" :before-close="handleClose">
            <el-form :model="createform" label-position="top" :rules="rules">
                <el-form-item label="标签名" prop="name">
                    <el-input v-model="createform.name" autocomplete="off" placeholder="请输入标签名"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="修改标签" :visible.sync="upatedialogFormVisible" :before-close="handleClose">
            <el-form :model="updateform" label-position="top" :rules="rules">
                <el-form-item label="标签名" prop="name">
                    <el-input v-model="updateform.name" autocomplete="off" placeholder="请输入标签名"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
