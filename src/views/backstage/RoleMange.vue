<template>
    <div class="RoleMange">
        ...
        <el-dialog title="创建角色" :visible.sync="createdialogFormVisible" :before-close="handleClose">
            <el-form :model="createform" label-position="top" :rules="rules">
                <el-form-item label="角色名" prop="name">
                    <el-input v-model="createform.name" autocomplete="off" placeholder="请输入角色名"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="修改角色" :visible.sync="upatedialogFormVisible" :before-close="handleClose">
            <el-form :model="updateform" label-position="top" :rules="rules">
                <el-form-item label="角色名" prop="name">
                    <el-input v-model="updateform.name" autocomplete="off" placeholder="请输入角色名"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
